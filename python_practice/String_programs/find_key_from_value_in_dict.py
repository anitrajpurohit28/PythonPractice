...
def get_key_from_dict_by_list_index(dict, val):
    """This function will return only first matching key
        with given value"""
...
def get_key_from_dict_iter_items(dict, val):
    """This function will return all the matching key
        with given value"""
...
get_key_from_dict_by_list_index(counter, 2)

get_key_from_dict_iter_items(my_dict, 110)
get_key_from_dict_iter_items(counter, 2)
